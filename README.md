# Android Messaging SDK v4.3.2

In-App Messaging SDK v4.3.2 for Android includes the Following:
* Fixed a bug that might lead to crash of messaging on Android KitKat(4.4).
